...
class Question6Activity : ComponentActivity() {
    ...
    MyAppDevelopTheme {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "아무도 날 건드리지 말아줘...여행의 목적은 휴식이라고 생각한다.",
                        color = Color.White,
                        fontWeight = FontWeight.Bold,
                        fontSize = 25.sp
                    ...
                    Row(
                        ...
                        Button(
                            onClick = {
                                val intent = Intent(context, ResultParisActivity::class.java)
                        ...
                        Button(
                            onClick = {
                                val intent = Intent(context, ResultNewYorkActivity::class.java)
                                context.startActivity(intent)
                            },
                            colors = ButtonDefaults.buttonColors(Color(0xFFA9A9A9))
                        ) {
        ...
        Box(
            ...
            Image(
                modifier = Modifier.fillMaxSize()
                    .size(150.dp),
                painter = painterResource(id = R.drawable.vacation7),
