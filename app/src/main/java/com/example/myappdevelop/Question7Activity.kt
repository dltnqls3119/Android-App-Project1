...
class Question7Activity: ComponentActivity() {
    ...
    MyAppDevelopTheme {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "여행을 생각하면 빨간색/노란색 보다는 하얀색/파란색이 생각나는 편이다.",
                        color = Color.White,
                        fontWeight = FontWeight.Bold,
                        fontSize = 25.sp
                    ...
                    Row(
                        ...
                        Button(
                            onClick = {
                                val intent = Intent(context, ResultBoracayActivity::class.java)
                        ...
                        Button(
                            onClick = {
                                val intent = Intent(context, ResultIcelandActivity::class.java)
                                context.startActivity(intent)
                            },
                            colors = ButtonDefaults.buttonColors(Color(0xFFA9A9A9))
                        ) {
        ...
        Box(
            ...
            Image(
                modifier = Modifier.fillMaxSize()
                    .size(150.dp),
                painter = painterResource(id = R.drawable.vacation9),
