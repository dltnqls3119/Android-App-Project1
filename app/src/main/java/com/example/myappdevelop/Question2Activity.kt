...
class Question2Activity : ComponentActivity() {
...
//                modifier = Modifier.border(width = 1.dp, color = Color.Black)
                    ...
                    Text(
                        text = "외국에 가면 한 도시에 있기 보다는 여러 도시 가는 것을 선호하는 편이다.",
                        color = Color.White,
                        fontWeight = FontWeight.Bold,
                        fontSize = 25.sp
                    ...
                    Row(
                        ...
                        Button(
                            onClick = {
                                val intent = Intent(context, Question4Activity::class.java)
                        ...
                        Button(
                            onClick = {
                                val intent = Intent(context, Question7Activity::class.java)
                                context.startActivity(intent)
                            },
                            colors = ButtonDefaults.buttonColors(Color(0xFFA9A9A9))
                        ) {
        ...
        Box(
            ...
            Image(
                modifier = Modifier.fillMaxSize()
                    .size(150.dp),
                painter = painterResource(id = R.drawable.vacation2),
