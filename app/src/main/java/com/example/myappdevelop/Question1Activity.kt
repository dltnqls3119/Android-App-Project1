...
class Question1Activity : ComponentActivity() {
        ...
        Box(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "여행은 사진이지! 여행가서 사진 100장은 찍어야 한다고 생각한다.",
                        color = Color.White,
                        fontWeight = FontWeight.Bold,
                        fontSize = 25.sp
                    ...
                    Row(
                        ...
                        Button(
                            onClick = {
                                val intent = Intent(context, Question2Activity::class.java)
                        ...
                        Button(
                            onClick = {
                                val intent = Intent(context, Question3Activity::class.java)
                                context.startActivity(intent)
                            },
                            colors = ButtonDefaults.buttonColors(Color(0xFFA9A9A9))
                        ) {
        ...
        Box(
            ...
            Image(
                modifier = Modifier
                    .fillMaxSize()
                    .size(100.dp),
                painter = painterResource(id = R.drawable.vacation1),
